...
public class JsonStringLocalizer : IStringLocalizer
{
    ...
    {
        return _localizaion.Where(l => l.Value.LocalizedValue.Keys.Any(lv => lv == CultureInfo.CurrentCulture.Name))
            .Select(l => new LocalizedString(l.Key, l.Value.LocalizedValue[CultureInfo.CurrentCulture.Name], true));
    }
    ...
    {
        var query = _localizaion.Where(l => l.Value.LocalizedValue.Keys.Any(lv => lv == CultureInfo.CurrentCulture.Name));
